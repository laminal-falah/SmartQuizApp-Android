...
public class ListKuisAdapter extends RecyclerView.Adapter<ListKuisAdapter.ViewHolderKuis> {

    private final ArrayList<Kuis> kuisList;
    private final Context context;

    public ListKuisAdapter(ArrayList<Kuis> kuis, Context context) {
        this.kuisList = kuis;
        ...
        viewHolderKuis.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                v.getContext().startActivity(new Intent(context, DetailKuisActivity.class)
                        ...
                        .putExtra("id", kuis.getId_kategori())
                        .putExtra("tipe","kategori")
                        .putExtra("nama", kuis.getJudul())
                        .putExtra("kategori", kuis.getNm_kategori())
