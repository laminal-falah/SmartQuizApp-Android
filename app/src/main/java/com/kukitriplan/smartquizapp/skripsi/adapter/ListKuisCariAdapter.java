...
public class ListKuisCariAdapter extends RecyclerView.Adapter<ListKuisCariAdapter.ViewHolderKuis> {

    private final ArrayList<Kuis> kuisList;
    private final Context context;

    public ListKuisCariAdapter(ArrayList<Kuis> kuis, Context context) {
        this.kuisList = kuis;
